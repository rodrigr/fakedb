export const profile = Vue.component('profile', {
	...
	template: `<div class="d-flex flex-column justify-content-around align-items-center">
					<template v-if="currentStudent.photo != null">
						<img class="pic profile" :alt="currentStudent.first_name + ' profile picture'" :src="'https://raw.githubusercontent.com/rodrigr/vue-demo/master/img/' + currentStudent.photo"> 
					</template>
					<template v-else>
						<img class="pic profile" :alt="currentStudent.first_name + ' profile picture'" src="https://raw.githubusercontent.com/rodrigr/vue-demo/master/img/default.png"> 
					</template>
